package ru.edakin.lab5_stp;

import ru.edakin.objects.Body;
import ru.edakin.objects.Cylinder;
import ru.edakin.objects.Cube;
import ru.edakin.objects.Cuboid;
import ru.edakin.objects.Cone;
import ru.edakin.objects.SortMode;
import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;
import java.util.*;
import static ru.edakin.lab5_stp.Lab5_stp.baze;
import static ru.edakin.lab5_stp.Lab5_stp.key;
import static ru.edakin.lab5_stp.Lab5_stp.test;
            ...
            switch(key)
            {
                case 1:
                    ...
                    if(baze.size()!=0 && pos != -1) 
                         {baze.add(pos,new ru.edakin.objects.Cube(id,Hight,name));}
                    else {baze.add(new ru.edakin.objects.Cube(id,Hight,name));}
                ...
                case 2:
                    ...
                    pos = pos -1;
                    if(baze.size()!=0 && pos != -1) 
                         {baze.add(pos,new ru.edakin.objects.Cuboid(id,Hight,Lengh,Width,name));}
                    else {baze.add(new ru.edakin.objects.Cuboid(id,Hight,Lengh,Width,name));}
                ...
                case 4:
                    ...
                    pos = pos -1;
                    if(baze.size()!=0 && pos != -1) 
                         {baze.add(pos,new ru.edakin.objects.Cone(id,Hight,R,name));}
                    else {baze.add(new ru.edakin.objects.Cone(id,Hight,R,name));}
                ...
                case 3:
                    ...
                    pos = pos -1;
                    if(baze.size()!=0 && pos != -1) 
                         {baze.add(pos,new ru.edakin.objects.Cylinder(id, Hight, R, name));}
                    else {baze.add(new ru.edakin.objects.Cylinder(id, Hight, R, name));}
